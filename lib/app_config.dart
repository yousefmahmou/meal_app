...
class AppConfig {
  static String copyright_text = "@ Alnamoos Fresh " + this_year; //this shows in the splash screen
  static String app_name = "Alnamoos Fresh Delivery App"; //this shows in the splash screen
  ...
  // static const DOMAIN_PATH = "192.168.0.138/ecommerce_deliveryboy";
  static const DOMAIN_PATH = "alnamoosfresh.ae";
